      ...
      <div className="container mt-5">
        <div className="search-box p-5 border rounded shadow-sm bg-white">
          ...
          <form onSubmit={handleProgramSubmit}>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="form-check form-check-inline">
                  <input
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="ug">Undergraduate (UG)</label>
                </div>
                <div className="form-check form-check-inline">
                  <input
                    className="form-check-input"
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="pg">Postgraduate (PG)</label>
                </div>
                <div className="form-check form-check-inline">
                  <input
                    className="form-check-input"
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="associate">Associate Degree</label>
                </div>
              </div>
            </div>
            <div className="form-group mb-4">
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="form-check form-check-inline">
                  <input
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="us">United States</label>
                </div>
                <div className="form-check form-check-inline">
                  <input
                    className="form-check-input"
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="uk">United Kingdom</label>
                </div>
                <div className="form-check form-check-inline">
                  <input
                    className="form-check-input"
                    ...
                    required
                  />
                  <label className="form-check-label" htmlFor="aus">Australia</label>
                </div>
              </div>
            </div>
            <div className="form-group mb-4">
            ...
            <button type="submit" className="btn btn-primary mt-3">Search Programs</button>
          </form>
        </div>
        ...
        <div className="search-box p-5 border rounded shadow-sm bg-white mt-4">
          ...
          <form onSubmit={handleCollegeSubmit}>
            ...
            <button type="submit" className="btn btn-secondary mt-3">Search Colleges</button>
          </form>
        </div>
      </div>
